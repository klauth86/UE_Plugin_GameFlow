...
#define LOCTEXT_NAMESPACE "FGameFlowCoreModule"
...
{
	States.Add(stateToAdd, NewObject<UGameFlowState>(this, NAME_None, RF_Transactional));
...
UGameFlowTransition* UGameFlow::AddTransition(const FGuid& fromState, const FGuid& toState)
{
	...
	transitionCollection.Transitions.FindOrAdd(toState) = NewObject<UGameFlowTransition>(this, NAME_None, RF_Transactional);
...
void FGameFlowCoreModule::StartupModule()
{
}

void FGameFlowCoreModule::ShutdownModule()
{
}
